...
var simon = function () {
  ...
  function addButton(i, hue, tone, position, positionSpan) {
    ...
    $btnsContainer.append($('<div/>', { 'class': 'psiSeqBtn', 'css': { 'transform': outerTransform } }).append($('<div/>', { 'class': 'psiSeqBtn_inner', 'css': { 'transform': innerTransform } }).append(buttons[i].$el)));
  }
