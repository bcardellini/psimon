...
var simon = function () {
  ...
  var minTone = 250;
  var badTone = 100;
  var buttonSaturation = "80%";
  var buttonLightness = "70%";
  var gapPercent = 0.5;
  var radiusPercent = 98;
  var toneTime = 500;
  var toneGap = 100;
  ...
  function addButton(i, hue, tone, position, positionSpan) {
    ...
    var pt1 = helpers.newRound((radiusPercent - gapPercent) * Math.cos(Math.PI / 180 * positionSpan / 2), 2) + " " + helpers.newRound((radiusPercent - gapPercent) * Math.sin(Math.PI / 180 * positionSpan / 2), 2);
    var pt2 = helpers.newRound((radiusPercent - gapPercent) * Math.cos(Math.PI / 180 * positionSpan / 2), 2) + " " + helpers.newRound((radiusPercent - gapPercent) * Math.sin(Math.PI / 180 * positionSpan / 2) * -1, 2);
  ...
  function userPressCorrect(event, id) {
    ...
    buttons[id].$sec.addClass('pressed').bind('mouseup mouseleave touchend', userReleaseCorrect);
    userMove++;
  }
  ...
  function userPressIncorrect(event, id) {
    ...
    buttons[id].$sec.addClass('wrong').bind('mouseup mouseleave touchend', userReleaseIncorrect);
  }
...
},{"./modules/helpers":3,"jQuery":1}],3:[function(require,module,exports){
'use strict';
